const maxTilt = 40; // Kartın dönebileceği max derece.
...
$(".b-game-card")
    .mousemove(function(evt) {
        ...
        $(".cover", this).css({
            ...
            filter: `brightness(${1.6 - bounding.y / bounding.height})` // 0.6 = offset, parlaklık 0.6 tan 1.6 ya kadar değer alıcak
        });
        $(".gloss", this).css({
